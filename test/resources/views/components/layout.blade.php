    ...
    <nav class="bg-gray-800">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-nav-link href="/trash" :active="request()->is('trash')"> Trash </x-nav-link>
              </div>
            </div>
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              @guest
                ...
                <x-nav-link href="/register" :active="request()->is('rigister')"> Regiter </x-nav-link>
              @endguest
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
          <a href="/" class="{{ request()->is('/') ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" }} block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Homepage</a>
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900"> {{$heading}} </h1>
          ...
          @if (request()->is('notes'))
            <x-button href="/notes/create" class='bg-pink-600 hover:bg-pink-500 focus-visible:outline-pink-600'>
              Create Note
            </x-button>
          {{-- @elseif( preg_match('/^notes\/[0-9]+\/edit$/', request()->path()) ) --}}
          @endif
