<x-layout > 
    ...
    <form method='POST' action="/notes/{{ $note->id }}">
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            ...
            <div class="flex item-center gap-x-6">
                ...
                <x-form-button form="copy-form" class='bg-purple-600 hover:bg-purple-500 focus-visible:outline-purple-600'>
                    Copy Note
                </x-form-button>
            </div>
            ...
            <div class="flex item-center gap-x-6">
                ...
                <x-form-cancel href="/notes/{{ $note->id }}" class='bg-indigo-600 hover:bg-indigo-500 focus-visible:outline-indigo-600'>
                    Cancel
                </x-form-cancel>
    ...
    <form method="POST" action="/notes/{{ $note->id }}/duplicate" id='copy-form' class="hidden">
        @csrf
    </form>
